...
public class Game : MonoBehaviour
{
    ...
    private void OnServerMessageMovements(ServerMessageMovements serverMessageMovements) {
        foreach (ObjectData p in serverMessageMovements.players) {
            ...
            remotePlayer.PlayerMovement.DestinationPosition = p.transform.position.ToVector3();
            remotePlayer.PlayerMovement.DestinationRotation = p.transform.rotation.ToVector3();
            remotePlayer.PlayerMovement.MovementData = p.movement;
        }
    }
